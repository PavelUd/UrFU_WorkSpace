...
public class WorkspaceObjectsService(IBaseRepository<WorkspaceObject> repository, ErrorHandler errorHandler) 
    : WorkspaceComponentService<WorkspaceObject>(repository, errorHandler)
{
